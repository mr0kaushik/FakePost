...
public class TweetWithText extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tweet_with_text);

        final Toolbar myToolbar = findViewById(R.id.my_toolbar);
        setSupportActionBar(myToolbar);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            Objects.requireNonNull(getSupportActionBar()).setTitle("Tweet with Text");
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
...
//        textViewLikes.setTypeface(font);
        ...
        name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TweetWithText.this);
        ...
        textViewTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(TweetWithText.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        textViewDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(TweetWithText.this,
        ...
        textViewDevice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(TweetWithText.this);
        ...
        profilePic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dexter.withActivity(TweetWithText.this)
    ...
    private void launchCameraIntent() {
        Intent intent = new Intent(TweetWithText.this, ImagePicker.class);
